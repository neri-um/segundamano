...
public abstract class RepositorioMongoDB<T extends Identificable> implements RepositorioString<T> {
	...
	public abstract Document getFilterById(String id);
	public abstract String getIdValue(BsonValue valor);
	...
	public String add(T entity) throws RepositorioException {
		...
		return getIdValue(identificador);
	...
	public void update(T entity) throws RepositorioException, EntidadNoEncontrada {
		try {
			Document filtro = getFilterById(entity.getId());// new Document("_id", new ObjectId(entity.getId()));
	...
	public void delete(T entity) throws RepositorioException, EntidadNoEncontrada {
		try {
			Document filtro = getFilterById(entity.getId());// Document("_id", new ObjectId(entity.getId()));
	...
	public T getById(String id) throws RepositorioException, EntidadNoEncontrada {
		try {
			Document filtro = getFilterById(id);
