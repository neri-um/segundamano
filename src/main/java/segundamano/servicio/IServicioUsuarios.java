...
La operación debe permitir modificar el nombre, apellidos, clave, fecha de nacimiento y teléfono
	 ...
	 */
	String altaUsuario(String nombre, String apellidos, String email, String clave, LocalDate fechaNac, int telefono);
	
	void modificarUsuario(String id, String nombre, String apellidos, String clave, String fechaNac, int telefono);
}
