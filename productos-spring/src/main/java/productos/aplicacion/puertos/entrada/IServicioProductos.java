 ...
 */
	...
	Page<Producto> buscarProductos(String categoria, String descripcion, Estado estado, Double precioMax, Pageable pageable) throws RepositorioException, EntidadNoEncontrada;
